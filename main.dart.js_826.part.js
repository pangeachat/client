...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nUz.prototype = {
    ...
    get$clickOnEmailLinkDesc() {
      return "Iltimos, elektron pochta xabaridagi havolani bosing va keyin davom eting. Agar elektron pochta xabari kelmasa, spam papkangizni tekshiring.";
    },
    get$didntReceiveEmail() {
      return "Elektron pochta xabarini olmadingizmi?";
    },
    get$resend() {
      return "Qayta jo'natish";
    },
    get$suggestedVocab() {
    ...
    get$notificationDeviceSubtitle() {
      return "Sizga push xabarnomalar yuboradigan qurilmalarni ko'ring va boshqaring.";
    },
    get$notificationRuleDM() {
      return "To'g'ridan-to'g'ri Xabar";
    },
    get$notificationRuleDMDescription() {
      return "Foydalanuvchini to'g'ridan-to'g'ri xabar xonalaridagi xabarlar haqida xabardor qiladi.";
    },
    get$notificationRuleCourseAndActivity() {
      return "Kurs va Faoliyat";
    },
