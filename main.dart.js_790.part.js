...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nNl.prototype = {
    ...
    get$writeAndSpeakWorryFree() {
      return "Schrijf en spreek zonder zorgen met Pangea Bot, altijd en overal!";
    },
    get$joinLearningCommunities() {
      return "Sluit je aan bij internationale leercommunities of... begin je eigen!";
    },
    get$playConversationGames() {
      return "Speel gespreksspellen met de bot, klasgenoten en nieuwe vrienden!";
    },
    get$jumpIntoConversation() {
      return "Duik vanaf dag \xe9\xe9n in gesprekken met AI-schrijfhulpmiddelen!";
    },
    get$playPersonalizedGames() {
      return "Speel oefenspellen die zijn gepersonaliseerd voor jouw vocabulaire en grammatica behoeften!";
    },
    get$hideEvents() {
    ...
    get$denyKnockChat() {
      return "Gebruiker zal worden afgewezen van de chat, echter kan hij/zij op elk moment later opnieuw proberen toe te treden.";
    },
    get$banFromSpace() {
      return "Verbod van de cursus";
    },
    get$unbanFromSpace() {
      return "Opheffen van het verbod van de cursus";
    },
    get$cannotJoinBannedRoom() {
      return "Verbannen. Kan niet deelnemen.";
    },
    get$sessionFull() {
      return "Te laat! Deze activiteit is vol.";
    },
    get$returnToCourse() {
      return "Terug naar cursus";
    },
    get$returnHome() {
      return "Terug naar huis";
    },
    get$translationFeedback() {
      return "Vertaalfeedback";
    },
    userUpdatedLearningSettings$1(username) {
      return username + " heeft de leerinstellingen bijgewerkt";
    },
    get$youUpdatedLearningSettings() {
      return "Je hebt je leerinstellingen bijgewerkt";
    },
    userAddedActivityPlan$1(username) {
      return username + " heeft een activiteitenplan toegevoegd";
    },
    get$youAddedActivityPlan() {
      return "Je hebt een activiteitenplan toegevoegd";
    },
    userSentActivitySummary$1(username) {
      return username + " heeft een activiteitenoverzicht verzonden";
    },
    get$youSentActivitySummary() {
      return "Je hebt een activiteitenoverzicht verzonden";
    },
    get$emptyInviteSearchHint() {
      return "Zie je niet wie je zoekt? Ze moeten mogelijk hun profiel openbaar maken in de Leerinstellingen";
    },
    get$suggestedVocab() {
      return "Voorgestelde vocabulaire";
    },
    get$myGender() {
      return "Mijn geslacht";
    },
    get$noAnalyticsActivitiesAvailable() {
      return "Wauw, je hebt alle beschikbare activiteiten voltooid! Stuur meer berichten om meer oefenactiviteiten te ontgrendelen.";
    },
...
;
(d => {
  d["xHyDEL2oyZrYIUQXYOo3j2B6LHg="] = d.current;
})($__dart_deferred_initializers__);
;
//# sourceMappingURL=main.dart.js_790.part.js.map
