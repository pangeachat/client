...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nEu.prototype = {
    ...
    get$clickOnEmailLinkDesc() {
      return "Mesedez, klikatu e-postako estekan eta jarraitu. Begiratu zure spam karpeta e-postak iritsi ez badira.";
    },
    get$didntReceiveEmail() {
      return "E-posta jaso al duzu?";
    },
    get$resend() {
      return "Berriro bidali";
    },
    get$suggestedVocab() {
    ...
    get$notificationDeviceSubtitle() {
      return "Ikusi eta kudeatu push jakinarazpenak bidaltzen dizkizuten gailuak.";
    },
    get$notificationRuleDM() {
      return "Mezu Zuzena";
    },
    get$notificationRuleDMDescription() {
      return "Erabiltzaileari mezu zuzenezko gelatan mezuen berri ematen dio.";
    },
    get$notificationRuleCourseAndActivity() {
      return "Ikastaroa eta Jarduera";
    },
