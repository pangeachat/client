...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nEs.prototype = {
    ...
    get$managementSnackbarMessage() {
      return "Hemos lanzado la gesti\xf3n de suscripciones en una nueva pesta\xf1a. Si no viste la nueva pesta\xf1a, por favor verifica tu bloqueador de ventanas emergentes.";
    },
    get$getStarted() {
      return "Comenzar";
    },
    get$writeAndSpeakWorryFree() {
      return "Escribe y habla sin preocupaciones con Pangea Bot en cualquier momento y lugar!";
    },
    get$joinLearningCommunities() {
      return "\xdanete a comunidades de aprendizaje internacionales o... \xa1comienza la tuya propia!";
    },
    get$playConversationGames() {
      return "Juega juegos de conversaci\xf3n con el bot, compa\xf1eros de clase y nuevos amigos!";
    },
    get$jumpIntoConversation() {
      return "Salta a la conversaci\xf3n desde el primer d\xeda con herramientas de escritura de IA!";
    },
    get$playPersonalizedGames() {
      return "Juega juegos de pr\xe1ctica personalizados seg\xfan tus necesidades de vocabulario y gram\xe1tica!";
    },
    get$hideEvents() {
    ...
    get$denyKnockChat() {
      return "El usuario ser\xe1 rechazado del chat, sin embargo, puede intentar unirse de nuevo en cualquier momento m\xe1s tarde.";
    },
    get$banFromSpace() {
      return "Prohibici\xf3n del curso";
    },
    get$unbanFromSpace() {
      return "Levantar la prohibici\xf3n del curso";
    },
    get$cannotJoinBannedRoom() {
      return "Prohibido. No se puede unirse.";
    },
    get$sessionFull() {
      return "\xa1Demasiado tarde! Esta actividad est\xe1 llena.";
    },
    get$returnToCourse() {
      return "Regresar al curso";
    },
    get$returnHome() {
      return "Regresar a casa";
    },
    get$translationFeedback() {
      return "Comentarios sobre la traducci\xf3n";
    },
    userUpdatedLearningSettings$1(username) {
      return username + " actualiz\xf3 la configuraci\xf3n de aprendizaje";
    },
    get$youUpdatedLearningSettings() {
      return "Has actualizado tu configuraci\xf3n de aprendizaje";
    },
    userAddedActivityPlan$1(username) {
      return username + " agreg\xf3 un plan de actividad";
    },
    get$youAddedActivityPlan() {
      return "Has agregado un plan de actividad";
    },
    userSentActivitySummary$1(username) {
      return username + " envi\xf3 un resumen de actividad";
    },
    ...
    get$noAnalyticsActivitiesAvailable() {
      return "\xa1Vaya, has completado todas las actividades disponibles! Env\xeda m\xe1s mensajes para desbloquear m\xe1s actividades de pr\xe1ctica.";
    },
...
;
(d => {
  d["d7tUH7OPxJrN3Lr0/d+NWLOpYhM="] = d.current;
