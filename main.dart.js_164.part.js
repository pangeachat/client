...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B = {
    L10nBe$() {
      return new B.L10nBe(A.canonicalizedLocale("be"));
    },
  ...
  (function inheritance() {
    ...
    _inherit(B.L10nBe, C.L10n);
  })();
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"L10nBe":{"L10n":[]}}'));
};
;
((d, h) => {
  d[h] = d.current;
  d.eventLog.push({p: "main.dart.js_164", e: "endPart", h: h});
})($__dart_deferred_initializers__, "R6XMMFMYp8fkgjdckbfwF3tCwxY=");
;
