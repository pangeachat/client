...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nId.prototype = {
    ...
    get$yourChatBackupHasBeenSetUp() {
      return "Cadangan obrolanmu telah disiapkan.";
    },
    get$chatBackupDescription() {
      return "Pesan lamamu diamankan dengan sebuah kunci pemulihan. Pastikan kamu tidak menghilangkannya.";
    },
    get$chatDetails() {
    ...
    get$recoveryKey() {
      return "Kunci pemulihan";
    },
    get$recoveryKeyLost() {
      return "Kunci pemulihan hilang?";
    },
    get$send(_) {
      return "Kirim";
    },
    ...
    get$transferFromAnotherDevice() {
      return "Transfer dari perangkat lain";
    },
    get$tryToSendAgain() {
    ...
    get$wipeChatBackup() {
      return "Hapus cadangan obrolan untuk membuat kunci pemulihan baru?";
    },
    get$writeAMessage() {
      return "Tulis pesan\u2026";
    },
    ...
    get$pleaseEnterRecoveryKeyDescription() {
      return "Untuk mengakses pesan lamamu, mohon masukkan kunci pemulihanmu yang telah dibuat di sesi sebelumnya. Kunci pemulihanmu BUKAN kata sandimu.";
    },
    get$markAsRead() {
    ...
    get$unlockOldMessages() {
      return "Akses pesan lama";
    },
    get$storeInSecureStorageDescription() {
      return "Simpan kunci pemulihan di penyimpanan aman perangkat ini.";
    },
    get$saveKeyManuallyDescription() {
      return "Simpan kunci ini secara manual dengan memicu dialog pembagian atau papan klip sistem.";
    },
    get$storeSecurlyOnThisDevice() {
      return "Simpan secara aman di perangkat ini";
    },
    countFiles$1(count) {
      return "" + count + " file";
    },
    ...
    get$groupCanBeFoundViaSearch() {
      return "Grup dapat dicari melalui pencarian";
    },
    ...
    get$moreEvents() {
      return "Peristiwa tambahan";
    },
    get$declineInvitation() {
      return "Tolak undangan";
    },
    get$noMessagesYet() {
    ...
    get$endPoll() {
      return "Akhiri jajak pendapat";
    },
    get$answersVisible() {
      return "Jawaban terlihat";
    },
    get$pollQuestion() {
      return "Pertanyaan jajak pendapat";
    },
    get$answerOption() {
      return "Opsi jawaban";
    },
    get$addAnswerOption() {
      return "Tambahkan opsi jawaban";
    },
    get$allowMultipleAnswers() {
      return "Izinkan beberapa jawaban";
    },
    get$pollHasBeenEnded() {
      return "Jajak pendapat telah diakhiri";
    },
    countVotes$1(count) {
      var _null = null;
      return B.Intl_pluralLogic(count, _null, this.localeName, _null, "Satu suara", "" + count + " suara", _null, _null);
    },
    get$answersWillBeVisibleWhenPollHasEnded() {
      return "Jawaban akan terlihat ketika jajak pendapat telah diakhiri";
    },
    get$replyInThread() {
      return "Balas di thread";
    },
    ...
    get$skipChatBackup() {
      return "Lewati cadangan obrolan";
    },
    get$skipChatBackupWarning() {
      return "Apakah Anda yakin? Tanpa mengaktifkan cadangan obrolan, Anda mungkin kehilangan akses ke pesan Anda jika Anda mengganti perangkat.";
    },
    get$loadingMessages() {
      return "Memuat pesan";
    },
    get$setupChatBackup() {
      return "Siapkan cadangan obrolan";
    },
    get$noMoreResultsFound() {
      return "Tidak ada hasil lagi yang ditemukan";
    },
    chatSearchedUntil$1(time) {
      return "Obrolan dicari hingga " + time;
    },
    get$federationBaseUrl() {
      return "URL Dasar Federasi";
    },
    get$clientWellKnownInformation() {
      return "Informasi Klien-Terkenal:";
    },
    get$baseUrl() {
      return "URL Dasar";
    },
    get$identityServer() {
      return "Server Identitas:";
    },
    ...
    get$publicInviteDescChat() {
      return "Cari pengguna untuk mengundang mereka ke obrolan ini.";
    },
    get$publicInviteDescSpace() {
      return "Cari pengguna untuk mengundang mereka ke ruang ini.";
    },
    get$enableNotificationsTitle() {
      return "Pangea Chat adalah aplikasi pesan, jadi notifikasi itu penting!";
    },
    get$enableNotificationsDesc() {
      return "Izinkan notifikasi";
    },
    get$useActivityImageAsChatBackground() {
      return "Gunakan gambar aktivitas sebagai latar belakang obrolan";
    },
    get$chatWithSupport() {
    ...
    get$supportSubtitle() {
      return "Pertanyaan? Kami di sini untuk membantu!";
    },
    get$autoIGCToolName() {
      return "Aktifkan bantuan penulisan";
    },
    ...
    get$selectAllWords() {
      return "Pilih semua kata yang Anda dengar dalam audio";
    },
    get$aboutMeHint() {
      return "Tentang saya";
    },
    ...
    get$joinCourseForActivities() {
      return "Bergabunglah dengan kursus untuk mencoba aktivitas.";
    },
    ...
    get$cannotJoinBannedRoom() {
      return "Dilarang. Tidak dapat bergabung.";
    },
    get$sessionFull() {
      return "Terlambat! Aktivitas ini sudah penuh.";
    },
    get$returnToCourse() {
      return "Kembali ke kursus";
    },
    get$returnHome() {
    ...
    get$clickOnEmailLinkDesc() {
      return "Silakan klik tautan di email dan kemudian lanjutkan. Periksa folder spam Anda jika email belum tiba.";
    },
    get$didntReceiveEmail() {
      return "Tidak menerima email?";
    },
    get$resend() {
      return "Kirim ulang";
    },
    ...
    get$notificationDeviceSubtitle() {
      return "Lihat dan kelola perangkat yang mengirimkan notifikasi push kepada Anda.";
    },
    get$notificationRuleDM() {
      return "Pesan Langsung";
    },
    get$notificationRuleDMDescription() {
      return "Memberitahukan pengguna tentang pesan di ruang pesan langsung.";
    },
    get$notificationRuleCourseAndActivity() {
      return "Kursus dan Aktivitas";
    },
