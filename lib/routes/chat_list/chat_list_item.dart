      ...
      child: Material(
        ...
        child: FutureBuilder(
          ...
          builder: (context, _) {
            ...
            // menu is reached by long-pressing the row (press-and-hold
            // works with a mouse as well). The one remaining live control, the
            ...
            return Stack(
              children: [
                // The long-press is announced, not just present: TalkBack
                ...
                Semantics(
                  ...
                  // Keyboard path to the menu — long-press has no keyboard
                  // equivalent of its own, so the row honors the standard
                  // context-menu bindings while it holds focus.
                            ...
                            child: isPendingInvite
                                ...
                                ? ExcludeSemantics(
                                    child: Text(
                                      ...
                                      L10n.of(
                                        context,
                                      ).countChats(room.spaceChildCount),
                                      // Pangea#
                                      style: TextStyle(
                ...
                if (trailingButton != null)
                  PositionedDirectional(
                    ...
                    top: 0,
                    bottom: 0,
                    child: Center(child: trailingButton),
                  ),
              ],
            );
          },
