...
/// The body of the left-column **add-course panel** (world_v2): the first step
/// of the add-course wizard, hosted as a URL-token panel instead of the retired
/// route-driven `_MainView` card. The step is the `addcourse` token's param —
/// `own` (start my own / plan list), `browse` (public courses), or `private`
/// (enter a code). Each hosted page carries its own header/close; the deeper
/// steps (`/courses/own/:courseid` …) stay route-driven detail. See
/// `routing.instructions.md`.
class AddCoursePanel extends StatelessWidget {
  /// The wizard step from the token param: `own`, `browse`, or `private`.
