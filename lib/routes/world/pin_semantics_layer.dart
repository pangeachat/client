        ...
        builder: (context, _) {
          ...
          return LayoutBuilder(
            builder: (context, constraints) {
              ...
              // One fixed touch-target box per pin, centered on its point —
              // the screen-reader focus highlight lands on the pin but does
              // not trace a teardrop's or large card's exact drawn rect.
              // Deliberate: per-tier rect mirroring was tried (#8646) and
              // dropped for simplicity; restore it from there if QA needs
              // the highlight to hug the larger tiers.
