...
import 'package:fluffychat/routes/chat/choreographer/choreographer_send_button.dart';
import 'package:fluffychat/routes/chat/choreographer/choreographer_state_extension.dart';
import 'package:fluffychat/routes/chat/choreographer/igc/start_igc_button.dart';
import 'package:fluffychat/routes/chat/input_bar.dart';
...
class PangeaChatInputRow extends StatelessWidget {
  ...
  // #Pangea
  final RecordingViewModelState recordingViewModel;
  // Pangea#
      ...
      children: [
        CompositedTransformTarget(
          ...
          child: Container(
            ...
            // #Pangea
            // RecordingViewModel is now created ABOVE this widget (in
            // chat_input_bar.dart) so its degradation banner can render as a
            // sibling above the composer's Material box instead of clipped
            // inside it. `recordingViewModel` is that single source of truth,
            // passed down as a field.
            child: recordingViewModel.isRecording
                ? RecordingInputRow(
                ...
                : Row(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: InputBar(
                            ...
                            showMatch: (m) =>
                                controller.showNextMatch(match: m),
                            onFeedbackSubmitted:
                      ...
                      CompositedTransformTarget(
                        link: controller.igcButtonLink.link,
                        child: StartIGCButton(
                          key: controller.igcButtonLink.key,
