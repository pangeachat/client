...
class PracticeRecord {
  late List<PracticeExerciseRecordResponse> responses;

  PracticeRecord({
    List<PracticeExerciseRecordResponse>? responses,
    DateTime? timestamp,
  }) {
    if (responses == null) {
      this.responses = List<PracticeExerciseRecordResponse>.empty(
        growable: true,
      );
    } else {
  ...
  factory PracticeRecord.fromJson(Map<String, dynamic> json) {
    return PracticeRecord(
      responses: (json['responses'] as List)
          .map(
            (e) => PracticeExerciseRecordResponse.fromJson(
  ...
  PracticeExerciseRecordResponse? get latestResponse {
...
class PracticeExerciseRecordResponse {
  ...
  //TODO - differentiate into different exercise types
  ConstructUseTypeEnum useType(PracticeExerciseTypeEnum aType) =>
      isCorrect ? aType.correctUse : aType.incorrectUse;

  factory PracticeExerciseRecordResponse.fromJson(Map<String, dynamic> json) {
    return PracticeExerciseRecordResponse(
  ...
  bool operator ==(Object other) {
    ...
    return other is PracticeExerciseRecordResponse &&
        other.text == text &&
