...
class MultipleChoicePracticeExercise {
  ...
  MultipleChoicePracticeExercise({
  ...
  factory MultipleChoicePracticeExercise.fromJson(Map<String, dynamic> json) {
    ...
    return MultipleChoicePracticeExercise(
  ...
  bool operator ==(Object other) {
    ...
    return other is MultipleChoicePracticeExercise &&
