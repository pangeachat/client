...
import 'package:fluffychat/pangea/analytics_practice/analytics_practice_choice_card_widget.dart';
...
class AnalyticsPracticeExerciseChoices extends StatelessWidget {
  ...
  const AnalyticsPracticeExerciseChoices({
    super.key,
  ...
  Widget build(BuildContext context) {
    if (analyticsPracticeExercise.exerciseType ==
        ...
        child: isComplete
            ...
            : Padding(
                ...
                child: Wrap(
                  ...
                  children: choices
                      .map(
                        (choice) => AnalyticsPracticeExerciseChoiceCard(
                          analyticsPracticeExercise: analyticsPracticeExercise,
                          targetId:
