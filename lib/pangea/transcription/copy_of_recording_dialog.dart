...
import 'package:fluffychat/pangea/transcription/transcription_controller.dart';
...
import '../../pages/chat/events/audio_player.dart';
...
class RecordingDialogState extends State<RecordingDialog> {
  ...
  TranscriptionController transcriptionController = TranscriptionController();
  ...
  void initState() {
    ...
    transcriptionController.initialize().then((value) {
      startRecording();
      //TODO hook up the transcription controller to the recording dialog somehow
    });
  ...
  Widget build(BuildContext context) {
    ...
    final content = error
      ...
      stream: transcriptionController.transcriptionStream,
...
class RecordingResult {
  ...
  //#Pangea
  final SpeechToTextModel? sttModel;
    //Pangea#
