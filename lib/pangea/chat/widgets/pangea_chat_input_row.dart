...
class PangeaChatInputRowState extends State<PangeaChatInputRow> {
  ...
  String hintText() {
    ...
    return activel1 != null &&
        ...
        ? L10n.of(
          context,
        ).writeAMessageLangCodes(activel1!.displayName, activel2!.displayName)
  ...
  void _sendAgainAction() {
    ...
    final allEditEvents = event
        .aggregatedEvents(_controller.timeline!, RelationshipTypes.edit)
                      ...
                      : <Widget>[
                        ...
                        AnimatedContainer(
                          ...
                          child: PopupMenuButton<String>(
                            ...
                            onSelected:
                                _controller.onAddPopupMenuButtonSelected,
                            itemBuilder:
                                (
                            ...
                            child: InputBar(
                              ...
                              onSubmitted:
                                  (String value) => _controller
                                      .onInputBarSubmitted(value, context),
