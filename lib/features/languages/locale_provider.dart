...
class LocaleProvider extends ChangeNotifier {
  ...
  void setLocale(String? value) {
    _locale = localeFromLangCode(value);
    notifyListeners();
  }

  /// The translation Flutter should render [value] — a CMS language code — in,
  /// or null when no translation matches it and the UI falls back to English.
  static Locale? localeFromLangCode(String? value) {
    ...
    if (!intl.DateFormat.localeExists(lang)) return null;
