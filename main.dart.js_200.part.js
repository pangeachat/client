...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B.L10nEs.prototype = {
    ...
    get$archiveRoomDescription() {
      return "El chat ser\xe1 movido al archivo. Otros usuarios podr\xe1n ver que has salido del chat.";
    },
    ...
    get$calculatingFileSize() {
      return "Calculando el tama\xf1o del archivo...";
    },
    get$prepareSendingAttachment() {
      return "Preparando el env\xedo del archivo adjunto...";
    },
    get$sendingAttachment() {
      return "Enviando archivo adjunto...";
    },
    sendingAttachmentCountOfCount$2(index, $length) {
      return "Enviando archivo adjunto " + index + " de " + $length + "...";
    },
    serverLimitReached$1(seconds) {
      return "\xa1L\xedmite del servidor alcanzado! Esperando " + seconds + " segundos...";
    },
    get$noticeChatBackupDeviceVerification() {
      return "Nota: Cuando conectas todos tus dispositivos a la copia de seguridad del chat, se verifican autom\xe1ticamente.";
    },
    ...
    get$setWallpaper() {
      return "Establecer fondo de pantalla";
    },
    get$noContactInformationProvided() {
      return "El servidor no proporciona ninguna informaci\xf3n de contacto v\xe1lida";
    },
    get$contactServerAdmin() {
      return "Contactar al administrador del servidor";
    },
    get$contactServerSecurity() {
      return "Contactar a la seguridad del servidor";
    },
    get$supportPage() {
      return "P\xe1gina de soporte";
    },
    ...
    get$addLink() {
      return "Agregar enlace";
    },
    get$unableToJoinChat() {
      return "No se puede unir al chat. Tal vez la otra parte ya ha cerrado la conversaci\xf3n.";
    },
    ...
    get$mandatoryUpdateRequiredDesc() {
      return "Se requiere una nueva versi\xf3n de la aplicaci\xf3n para continuar. Por favor actualice ahora para proceder.";
    },
    ...
    get$constructUseCorHWLDesc() {
      return "Correcto en la actividad de palabras ocultas";
    },
    get$constructUseIncHWLDesc() {
      return "Incorrecto en la actividad de palabras ocultas";
    },
    get$constructUseIgnHWLDesc() {
      return "Ignorado en la actividad de palabras ocultas";
    },
    ...
    get$constructUseCorMDesc() {
      return "Correcto en la actividad gramatical";
    },
    get$constructUseIncMDesc() {
      return "Incorrecto en la actividad gramatical";
    },
    ...
    get$signUpWithEmail() {
      return "Registrarse con correo electr\xf3nico";
    },
    ...
    get$analyticsNotAvailable() {
      return "An\xe1lisis de usuario no disponible";
    },
    get$downloading() {
      return "Descargando...";
    },
    get$failedFetchUserAnalytics() {
      return "Error al descargar el an\xe1lisis de usuario";
    },
    get$downloadComplete() {
      return "\xa1Descarga completa!";
    },
    whatIsTheMorphTag$2(morphologicalFeature, wordForm) {
      return "\xbfCu\xe1l es el " + morphologicalFeature + " de '" + wordForm + "'?";
    },
    get$dataAvailable() {
    ...
    get$notInClass() {
      return "\xa1No est\xe1s en una clase!";
    },
    get$noClassCode() {
      return "\xa1No hay c\xf3digo de clase!";
    },
    get$otherPartyNotLoggedIn() {
      return "\xa1La otra parte no ha iniciado sesi\xf3n y, por lo tanto, no puede recibir mensajes!";
    },
    ...
    get$leaveSpaceDescription() {
      return "El espacio se mover\xe1 al archivo. Otros usuarios podr\xe1n ver que has dejado el chat.";
    },
    get$open(_) {
      return "Abrir";
    },
...
})($__dart_deferred_initializers__, "kbJhp0P4zhlOTzxtoaHvqHyclmM=");
;
