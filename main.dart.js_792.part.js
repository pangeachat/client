...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nNl.prototype = {
    ...
    get$clickOnEmailLinkDesc() {
      return "Klik alstublieft op de link in de e-mail en ga dan verder. Controleer uw spamfolder als de e-mail niet is aangekomen.";
    },
    get$didntReceiveEmail() {
      return "Geen e-mail ontvangen?";
    },
    get$resend() {
      return "Opnieuw verzenden";
    },
    get$suggestedVocab() {
    ...
    get$notificationDeviceSubtitle() {
      return "Bekijk en beheer apparaten die u pushmeldingen sturen.";
    },
    get$notificationRuleDM() {
      return "Directe Bericht";
    },
    get$notificationRuleDMDescription() {
      return "Stelt de gebruiker op de hoogte van berichten in directe berichtkamers.";
    },
    get$notificationRuleCourseAndActivity() {
      return "Cursus en Activiteit";
    },
    get$notificationRuleCourseAndActivityDescription() {
      return "Stelt de gebruiker op de hoogte van berichten in cursussen, activiteiten en chats.";
    },
    ...
    get$selectAudioMessagesOnPlayToolName() {
      return "Automatisch audio berichten markeren";
    },
    get$selectAudioMessagesOnPlayDescription() {
      return "Audio berichten automatisch markeren wanneer ze worden afgespeeld";
    },
...
;
(d => {
  d["9Sj55Xu59OyJEf7NQ1t3PBmej+s="] = d.current;
