...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nCa.prototype = {
    ...
    changedTheChatDescription$1(username) {
      return username + " ha canviat la descripci\xf3 del xat";
    },
    ...
    get$yourChatBackupHasBeenSetUp() {
      return "S\u2019ha configurat la c\xf2pia de seguretat del xat.";
    },
    get$chatBackupDescription() {
      return "Els teus xats antics estan protegits amb una clau de recuperaci\xf3. Assegureu-vos de no perdre-la.";
    },
    get$chatDetails() {
    ...
    get$recoveryKey() {
      return "Clau de recuperaci\xf3";
    },
    get$recoveryKeyLost() {
      return "Que has perdut la clau de recuperaci\xf3?";
    },
    get$send(_) {
      return "Envia";
    },
    ...
    get$transferFromAnotherDevice() {
      return "Transfereix des d\u2019un altre dispositiu";
    },
    get$tryToSendAgain() {
    ...
    get$wipeChatBackup() {
      return "Voleu suprimir la c\xf2pia de seguretat dels xats per a crear una clau de recuperaci\xf3 nova?";
    },
    get$writeAMessage() {
    ...
    get$pleaseEnterRecoveryKeyDescription() {
      return "Per desbloquejar els missatges antics, introdueix la clau de recuperaci\xf3 que vas generar en una sessi\xf3 anterior. La clau de recuperaci\xf3 NO \xe9s la teva contrasenya.";
    },
    get$markAsRead() {
    ...
    get$unlockOldMessages() {
      return "Desbloqueja els missatges antics";
    },
    get$storeInSecureStorageDescription() {
      return "Desa la clau de recuperaci\xf3 en l'emmagatzematge segur d'aquest dispositiu.";
    },
    get$saveKeyManuallyDescription() {
      return "Per desar aquesta clau manualment, pica l'eina de compartir o copia-la al porta-retalls.";
    },
    get$storeSecurlyOnThisDevice() {
      return "Desa de forma segura en aquest dispositiu";
    },
    countFiles$1(count) {
      return "" + count + " arxius";
    },
    ...
    get$newSpaceDescription() {
      return "Els espais et permeten consolidar els teus xats i construir comunitats p\xfabliques o privades.";
    },
    get$reopenChat() {
    ...
    get$createGroupAndInviteUsers() {
      return "Crea un grup i convida-hi usu\xe0r\xefis";
    },
    get$groupCanBeFoundViaSearch() {
      return "El grup es pot trobar per la cerca general";
    },
    ...
    get$moreEvents() {
      return "M\xe9s esdeveniments";
    },
    get$declineInvitation() {
      return "Rebutjar invitaci\xf3";
    },
    get$noMessagesYet() {
    ...
    get$startPoll() {
      return "Inicia l'enquesta";
    },
    get$endPoll() {
      return "Finalitza l'enquesta";
    },
    get$answersVisible() {
      return "Respostes visibles";
    },
    get$pollQuestion() {
      return "Pregunta de l'enquesta";
    },
    get$answerOption() {
      return "Opci\xf3 de resposta";
    },
    get$addAnswerOption() {
      return "Afegir opci\xf3 de resposta";
    },
    get$allowMultipleAnswers() {
      return "Permetre m\xfaltiples respostes";
    },
    get$pollHasBeenEnded() {
      return "L'enquesta ha estat finalitzada";
    },
    countVotes$1(count) {
      var _null = null;
      return B.Intl_pluralLogic(count, _null, this.localeName, _null, "Un vot", "" + count + " vots", _null, _null);
    },
    get$answersWillBeVisibleWhenPollHasEnded() {
      return "Les respostes seran visibles quan l'enquesta hagi acabat";
    },
    get$replyInThread() {
      return "Respondre en el fil";
    },
    countReplies$1(count) {
      var _null = null;
      return B.Intl_pluralLogic(count, _null, this.localeName, _null, "Una resposta", "" + count + " respostes", _null, _null);
    },
    get$thread() {
      return "Fil";
    },
    get$backToMainChat() {
      return "Tornar al xat principal";
    },
    get$saveChanges() {
      return "Desa els canvis";
    },
    get$createSticker() {
      return "Crear adhesiu o emoji";
    },
    get$useAsSticker() {
      return "Utilitzar com a adhesiu";
    },
    get$useAsEmoji() {
      return "Utilitzar com a emoji";
    },
    get$stickerPackNameAlreadyExists() {
      return "El nom del paquet d'adhesius ja existeix";
    },
    get$newStickerPack() {
      return "Nou paquet d'adhesius";
    },
    get$stickerPackName() {
      return "Nom del paquet d'adhesius";
    },
    get$attribution(_) {
      return "Atribuci\xf3";
    },
    get$skipChatBackup() {
      return "Saltar la c\xf2pia de seguretat del xat";
    },
    get$skipChatBackupWarning() {
      return "Est\xe0s segur? Sense habilitar la c\xf2pia de seguretat del xat, podries perdre l'acc\xe9s als teus missatges si canvies de dispositiu.";
    },
    get$loadingMessages() {
      return "Carregant missatges";
    },
    get$setupChatBackup() {
      return "Configura la c\xf2pia de seguretat del xat";
    },
    get$noMoreResultsFound() {
      return "No s'han trobat m\xe9s resultats";
    },
    chatSearchedUntil$1(time) {
      return "Xat cercat fins a " + time;
    },
    get$federationBaseUrl() {
      return "URL base de la federaci\xf3";
    },
    get$clientWellKnownInformation() {
      return "Informaci\xf3 coneguda del client:";
    },
    get$baseUrl() {
      return "URL base";
    },
    get$identityServer() {
      return "Servidor d'identitat:";
    },
    versionWithNumber$1(version) {
      return "Versi\xf3: " + version;
    },
    get$logs() {
      return "Registres";
    },
    get$advancedConfigs() {
      return "Configuracions avan\xe7ades";
    },
    ...
    get$knockAccepted() {
      return "La teva sol\xb7licitud d'uni\xf3 ha estat acceptada! Ara pots entrar al curs.";
    },
    get$findCourse() {
    ...
    get$enableNotificationsTitle() {
      return "Pangea Chat \xe9s una aplicaci\xf3 de missatgeria, aix\xed que les notificacions s\xf3n importants!";
    },
    get$enableNotificationsDesc() {
      return "Permetre notificacions";
    },
    ...
    get$searchLanguagesHint() {
      return "Cerca lleng\xfces objectiu";
    },
    get$supportSubtitle() {
    ...
    get$selectAllWords() {
      return "Selecciona totes les paraules que escoltes a l'\xe0udio";
    },
    get$aboutMeHint() {
      return "Sobre mi";
    },
    get$changeEmail() {
      return "Canvia l'email";
    },
    get$withTheseAddressesDescription() {
      return "Amb aquestes adreces de correu electr\xf2nic pots iniciar sessi\xf3, recuperar la teva contrasenya i gestionar les subscripcions.";
    },
    get$noAddressDescription() {
      return "Encara no has afegit cap adre\xe7a de correu electr\xf2nic.";
    },
    get$perfectPractice() {
    ...
    get$joinCourseForActivities() {
      return "Uneix-te a un curs per provar activitats.";
    },
    ...
    get$learnLanguageWhileTexting() {
      return "Apr\xe8n un idioma mentre envies missatges als teus amics!";
    },
    get$denyKnockSpace() {
    ...
    get$cannotJoinBannedRoom() {
      return "Prohibit. No es pot unir.";
    },
    get$sessionFull() {
      return " massa tard! Aquesta activitat est\xe0 completa.";
    },
    get$returnToCourse() {
      return "Torna al curs";
    },
    get$returnHome() {
      return "Torna a casa";
    },
    ...
    get$clickOnEmailLinkDesc() {
      return "Si us plau, feu clic a l'enlla\xe7 de l'email i despr\xe9s continueu. Comproveu la vostra carpeta de spam si l'email no ha arribat.";
    },
    get$didntReceiveEmail() {
      return "No heu rebut l'email?";
    },
    get$resend() {
      return "Reenviar";
    },
    ...
    get$notificationDeviceSubtitle() {
      return "Veure i gestionar dispositius que us envien notificacions push.";
    },
    get$notificationRuleDM() {
      return "Missatge Directe";
    },
    get$notificationRuleDMDescription() {
      return "Notifica a l'usuari sobre missatges a les sales de missatges directes.";
    },
    get$notificationRuleCourseAndActivity() {
      return "Curs i Activitat";
    },
    ...
    get$joinSpaceOnboardingDesc() {
      return "En una classe? Posar el vostre codi d'uni\xf3 aqu\xed.";
    },
    get$selectAudioMessagesOnPlayToolName() {
      return "Destacar autom\xe0ticament els missatges d'\xe0udio";
    },
    get$selectAudioMessagesOnPlayDescription() {
      return "Destacar autom\xe0ticament els missatges d'\xe0udio quan es reprodueixin";
    },
    get$learningAnalytics() {
      return "An\xe0lisi de l'aprenentatge";
    },
...
;
(d => {
  d["pAVufP/4nwJLvqipm0qeJhM5I7o="] = d.current;
