...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nIt.prototype = {
    ...
    get$knockAccepted() {
      return "La tua richiesta di partecipazione \xe8 stata accettata! Puoi ora entrare nel corso.";
    },
    ...
    get$unlockPracticeActivities() {
      return "Sblocca le attivit\xe0 di pratica";
    },
    ...
    get$learnLanguageWhileTexting() {
      return "Impara una lingua mentre messaggi i tuoi amici!";
    },
    get$denyKnockSpace() {
      return "L'utente sar\xe0 escluso dal corso, tuttavia potr\xe0 tentare di rientrare in qualsiasi momento successivo.";
    },
    get$denyKnockChat() {
      return "L'utente sar\xe0 escluso dalla chat, tuttavia potr\xe0 tentare di rientrare in qualsiasi momento successivo.";
    },
    get$banFromSpace() {
      return "Divieto di partecipazione al corso";
    },
    get$unbanFromSpace() {
      return "Revoca del divieto di partecipazione al corso";
    },
    get$cannotJoinBannedRoom() {
      return "Bannato. Impossibile unirsi.";
    },
    get$sessionFull() {
    ...
    get$emptyInviteSearchHint() {
      return "Non vedi chi stai cercando? Potrebbero dover impostare il loro profilo su pubblico nelle Impostazioni di Apprendimento";
    },
    get$clickOnEmailLinkDesc() {
      return "Si prega di fare clic sul link nell'email e poi procedere. Controlla la tua cartella spam se l'email non \xe8 arrivata.";
    },
    ...
    get$suggestedVocab() {
      return "Vocabolario suggerito";
    },
    get$myGender() {
      return "Il mio genere";
    },
    get$noAnalyticsActivitiesAvailable() {
      return "Wow, hai completato tutte le attivit\xe0 disponibili! Invia pi\xf9 messaggi per sbloccare ulteriori attivit\xe0 di pratica.";
    },
    get$profile() {
      return "Profilo";
    },
    ...
    get$notificationRuleDMDescription() {
      return "Notifica all'utente i messaggi nelle stanze di messaggi diretti.";
    },
    get$notificationRuleCourseAndActivity() {
      return "Corso e Attivit\xe0";
    },
    get$notificationRuleCourseAndActivityDescription() {
      return "Notifica all'utente i messaggi nei corsi, nelle attivit\xe0 e nelle chat.";
    },
    get$enableEmailNotifications() {
      return "Abilita le notifiche email";
    },
...
;
(d => {
  d["jZdbd/Uj08IsS2/GdIzSCz6/CTY="] = d.current;
