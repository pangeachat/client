...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  A.L10nEu.prototype = {
    ...
    get$yourChatBackupHasBeenSetUp() {
      return "Txaten babeskopiak ezarri dira.";
    },
    get$chatBackupDescription() {
      return "Txat zaharrak berreskuratze-gako batekin daude babestuta. Ez galdu gako hori.";
    },
    get$chatDetails() {
    ...
    get$commandHint_join() {
      return "Batu adierazitako gelara";
    },
    ...
    get$recoveryKey() {
      return "Berreskuratze-gakoa";
    },
    get$recoveryKeyLost() {
      return "Berreskuratze-gakoa galdu duzu?";
    },
    get$send(_) {
      return "Bidali";
    },
    ...
    get$transferFromAnotherDevice() {
      return "Beste gailu batetik transferitu";
    },
    get$tryToSendAgain() {
    ...
    get$wipeChatBackup() {
      return "Ezabatu txataren babeskopia berreskuratze-gako berria sortzeko?";
    },
    get$writeAMessage() {
      return "Idatzi mezua\u2026";
    },
    ...
    get$pleaseEnterRecoveryKeyDescription() {
      return "Mezu zaharrak ikusi ahal izateko, sartu aurreko saioan sortu zen berreskuratze-gakoa. Berreskuratze-gakoa EZ da zure pasahitza.";
    },
    get$markAsRead() {
    ...
    get$unlockOldMessages() {
      return "Desblokeatu mezu zaharrak";
    },
    get$storeInSecureStorageDescription() {
      return "Gorde berreskuratze-gakoa gailu honetako biltegiratze seguruan.";
    },
    get$saveKeyManuallyDescription() {
      return "Gorde eskuz gako hau gailuko partekatze-menua edo arbela erabiliz.";
    },
    get$storeSecurlyOnThisDevice() {
      return "Gorde gailu honetan modu seguruan";
    },
    countFiles$1(count) {
    ...
    get$groupCanBeFoundViaSearch() {
      return "Bilaketa erabiliz aurkitu daiteke taldea";
    },
    ...
    get$commandHint_logout() {
      return "Amaitu saioa gailu honetan";
    },
    get$commandHint_logoutall() {
      return "Amaitu saioa aktibo dauden gailu guztietan";
    },
    get$moreEvents() {
      return "Gertaera gehiago";
    },
    get$declineInvitation() {
      return "Uko egin gonbidapenari";
    },
    get$noMessagesYet() {
    ...
    get$endPoll() {
      return "Amaitu bozketa";
    },
    get$answersVisible() {
      return "Erakutsi emaitzak";
    },
    get$pollQuestion() {
      return "Bozketako galdera";
    },
    get$answerOption() {
      return "Erantzun-aukera";
    },
    get$addAnswerOption() {
      return "Gehitu erantzun-aukera";
    },
    get$allowMultipleAnswers() {
      return "Baimendu erantzun bat baino gehiago";
    },
    get$pollHasBeenEnded() {
      return "Bozketa amaitu da";
    },
    countVotes$1(count) {
      var _null = null;
      return B.Intl_pluralLogic(count, _null, this.localeName, _null, "Bozka bat", "" + count + " bozka", _null, _null);
    },
    get$answersWillBeVisibleWhenPollHasEnded() {
      return "Emaitzak bozketak amaitu duenean egongo dira ikusgai";
    },
    get$replyInThread() {
      return "Erantzun harian";
    },
    countReplies$1(count) {
      var _null = null;
      return B.Intl_pluralLogic(count, _null, this.localeName, _null, "Erantzun bat", "" + count + " erantzun", _null, _null);
    },
    get$thread() {
      return "Haria";
    },
    get$backToMainChat() {
      return "Joan txat nagusira";
    },
    get$saveChanges() {
      return "Gorde aldaketak";
    },
    get$createSticker() {
      return "Sortu pegatina edo emojia";
    },
    get$useAsSticker() {
      return "Erabili pegatina gisa";
    },
    get$useAsEmoji() {
      return "Erabili emoji gisa";
    },
    get$stickerPackNameAlreadyExists() {
      return "Pegatina-sortaren izena badago lehendik ere";
    },
    get$newStickerPack() {
      return "Pegatina-sorta berria";
    },
    get$stickerPackName() {
      return "Pegatina-sortaren izena";
    },
    get$attribution(_) {
      return "Sortzailea";
    },
    get$skipChatBackup() {
      return "Ez egin txataren babeskopia";
    },
    get$skipChatBackupWarning() {
      return "Ziur? Txataren babeskopia gaitzen ez baduzu, gailuz aldatuz gero mezuen sarbidea gal zenezake.";
    },
    get$loadingMessages() {
      return "Mezuak kargatzen";
    },
    get$setupChatBackup() {
      return "Ezarri txataren babeskopia";
    },
    get$noMoreResultsFound() {
      return "Ez da gehiago emaitzarik aurkitu";
    },
    chatSearchedUntil$1(time) {
      return "Txatean bilaketa " + time + " arte egin da";
    },
    get$federationBaseUrl() {
      return "Federazioaren oinarri URL-a";
    },
    get$clientWellKnownInformation() {
      return "Bezeroaren ezagutza ona:";
    },
    get$baseUrl() {
      return "Oinarri URL-a";
    },
    get$identityServer() {
      return "Identitate zerbitzaria:";
    },
    ...
    get$advancedConfigs() {
      return "Konfigurazio aurreratuak";
    },
    ...
    get$spanTypeCapitalization() {
      return "Kapitalizazioa";
    },
    get$spanTypeCorrection() {
      return "Zuzenketa";
    },
    get$spanFeedbackTitle() {
      return "Zuzenketa arazoa txostenatu";
    },
    get$selectAllWords() {
      return "Hitz guztiak hautatu audioan entzuten duzun guztia";
    },
    get$aboutMeHint() {
      return "Niri buruz";
    },
    ...
    get$writeAndSpeakWorryFree() {
      return "Idatzi eta hitz egin kezkatu gabe Pangea Bot-ekin edozein unetan, edozein lekutan!";
    },
    get$joinLearningCommunities() {
      return "Bat egin nazioarteko ikaskuntza komunitateekin edo... hasi zurea!";
    },
    get$playConversationGames() {
      return "Jolastu elkarrizketa jokoekin botarekin, ikaskideekin eta lagun berriekin!";
    },
    get$jumpIntoConversation() {
      return "Sartu elkarrizketan Lehen Egunean AI idazketa tresnekin!";
    },
    get$playPersonalizedGames() {
      return "Jolastu zure hiztegi eta gramatika beharrak pertsonalizatutako praktika jokoekin!";
    },
    get$hideEvents() {
      return "Ezkutatu ekitaldiak";
    },
    get$learnLanguageWhileTexting() {
      return "Ikasi hizkuntza lagunekin mezuak bidaltzen ari zaren bitartean!";
    },
    get$denyKnockSpace() {
      return "Erabiltzailea ikastetxetik baztertuko da, baina edozein unetan berriro sartzen saiatuko da.";
    },
    get$denyKnockChat() {
      return "Erabiltzailea txatetik baztertuko da, baina edozein unetan berriro sartzen saiatuko da.";
    },
    get$banFromSpace() {
      return "Ikastetxetik debekatzea";
    },
    get$unbanFromSpace() {
      return "Ikastetxetik debekua kentzea";
    },
    get$cannotJoinBannedRoom() {
      return "Debekatuta. Ez da posible sartzea.";
    },
    get$sessionFull() {
      return "Berandu! Jarduera hau beteta dago.";
    },
    get$returnToCourse() {
      return "Itzuli ikastaroara";
    },
    get$returnHome() {
      return "Itzuli etxera";
    },
    get$translationFeedback() {
      return "Itzulpen Feedback";
    },
    userUpdatedLearningSettings$1(username) {
      return username + " ikasketa ezarpenak eguneratu ditu";
    },
    get$youUpdatedLearningSettings() {
      return "Zuk ikasketa ezarpenak eguneratu dituzu";
    },
    userAddedActivityPlan$1(username) {
      return username + " jarduera plana gehitu du";
    },
    get$youAddedActivityPlan() {
      return "Zuk jarduera plana gehitu duzu";
    },
    userSentActivitySummary$1(username) {
      return username + " jarduera laburpena bidali du";
    },
    ...
    get$noAnalyticsActivitiesAvailable() {
      return "Wow, guztiak amaitu dituzu eskuragarri dauden jarduerak! Bidali gehiago mezu gehiago praktikatzeko jarduera gehiago irekitzeko.";
    },
    get$profile() {
      return "Profila";
    },
...
;
(d => {
  d["H9thZOmJGRor9yr1CX0Gg0tlOS0="] = d.current;
